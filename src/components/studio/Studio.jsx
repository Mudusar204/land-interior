...
const Studio = () => {
    return (
        <div id='studio'>
            <h1 className='text-4xl text-center mb-14 mt-10 font-medium max-md:text-left max-md:pl-10 max-md:mb-7'>Our Interior Design Products</h1>

            
            <div className=' flex justify-center'>

                <div className='flex justify-center w-[80%] max-md:w-[85%] gap-2'>
                    <div >
                    ...
                    <div className='max-md:hidden'><img src={studioImg6} alt="" /></div>
                </div>
            </div>
            <h1 className='text-center mt-4 text-xl max-md:text-left max-md:pl-10'>Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, <br />
